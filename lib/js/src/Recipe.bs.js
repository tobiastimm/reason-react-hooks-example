              ...
              className: card
                  ...
                  className: cardActions
                      ...
                      onClick: (function (param) {
                          var id = recipe.id;
                          return ReasonReactRouter.push("recipe/" + (String(id) + "/edit"));
                        })
                    }, React.createElement((function (prim) {
                            return ReactFeather.Edit(prim);
                          }), FeaterIcons$ReactHooksTemplate.Edit[/* makeProps */0](undefined, "#" + Theme$ReactHooksTemplate.colorButton, /* () */0))), React.createElement("button", {
                      className: cardAction
                    }, React.createElement((function (prim) {
                            return ReactFeather.Trash(prim);
                          }), FeaterIcons$ReactHooksTemplate.Trash[/* makeProps */0](undefined, "#" + Theme$ReactHooksTemplate.colorButton, /* () */0)))));
}
